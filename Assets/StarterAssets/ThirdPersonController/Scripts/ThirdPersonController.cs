...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        {
            if (gameObject.CompareTag("Player"))  //BK Added 11/14/22 so clones of the Player don't try (can't find where this event fires)
            {
...
/*
 //////////////////////////// Latest that did not include FootSteps
using UnityEngine;
using UnityEngine.Events;
#if ENABLE_INPUT_SYSTEM && STARTER_ASSETS_PACKAGES_CHECKED
using UnityEngine.InputSystem;
...
//
/*
// ////////////////////////////////////This is with modifications including event driven cam angle change 
using UnityEngine;
using UnityEngine.Events;
#if ENABLE_INPUT_SYSTEM && STARTER_ASSETS_PACKAGES_CHECKED
using UnityEngine.InputSystem;
